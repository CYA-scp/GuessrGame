export interface Location {
  ...
  name: string; country: string; flag: string; hint: string;
  pov?: { heading: number; pitch: number };
}

export const WORLD_LOCATIONS: Location[] = [
  { lat: 48.8584, lng: 2.2945, name: "Paris, Fransa", country: "Fransa", flag: "🇫🇷", hint: "Dəmir qüllənin gölgəsi", pov: { heading: 120, pitch: 0 } },
  ...
  { lat: -33.9249, lng: 18.4241, name: "Kəptown, Cənubi Afrika", country: "Cənubi Afrika", flag: "🇿🇦", hint: "Masa dağının ətəyi", pov: { heading: 315, pitch: 0 } },
  ...
  { lat: 40.4168, lng: -3.7038, name: "Madrid, İspaniya", country: "İspaniya", flag: "🇪🇸", hint: "Flamenkonun paytaxtı", pov: { heading: 45, pitch: 0 } },
  { lat: 48.2082, lng: 16.3738, name: "Vyana, Avstriya", country: "Avstriya", flag: "🇦🇹", hint: "Klassik musiqi şəhəri", pov: { heading: 90, pitch: 0 } },
];

export function getRandomLocations(count: number): Location[] {
  return [...WORLD_LOCATIONS].sort(() => Math.random() - 0.5).slice(0, count);
}
